...
public class AuthController {
    ...
    public ResponseEntity<UserDto> createUser(@RequestBody RegisterUserDto userDto){
        User createdUser = authenticationService.registerUser(userDto.login(), userDto.password(), userDto.age());
    ...
    public ResponseEntity<JwtResponse> authenticateUser(@RequestBody RegisterUserDto userDto){
